...
module Value_Inferencer.BugDetection.TaggedCircomlib.MultiMux1Test (spec) where
...
spec = describe "MultiMux1 Template Test" $ do
  it "successfully completes analysis without detecting bugs" $ do
    ...
    -- template parameter
    let n = 2 -- using 2 elements for this test
    ...
    let c_0_0 = Binding { name = "c_0_0", vid = 1, sort = FieldMod p, tag = Nothing } -- c[0][0]
    let c_0_1 = Binding { name = "c_0_1", vid = 2, sort = FieldMod p, tag = Nothing } -- c[0][1]
    let c_1_0 = Binding { name = "c_1_0", vid = 3, sort = FieldMod p, tag = Nothing } -- c[1][0]
    let c_1_1 = Binding { name = "c_1_1", vid = 4, sort = FieldMod p, tag = Nothing } -- c[1][1]

    -- outputs
    let out_0 = Binding { name = "out_0", vid = 5, sort = FieldMod p, tag = Nothing } -- out[0]
    let out_1 = Binding { name = "out_1", vid = 6, sort = FieldMod p, tag = Nothing } -- out[1]
