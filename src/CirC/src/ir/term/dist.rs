...
#[cfg(test)]
/// Test utilities for term generation and testing
pub mod test {
    use super::*;
    ...
    /// A pure boolean term with variable assignments for testing
    #[derive(Clone, Debug)]
    ...
    /// An arbitrary term wrapper for quickcheck testing
    #[derive(Clone)]
