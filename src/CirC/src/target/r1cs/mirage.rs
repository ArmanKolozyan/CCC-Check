    ...
    E::Fr: PrimeFieldBits,
{
    ...
    fn cp_setup(
        ...
        let cks = (0..num_cmts)
            ...
            .collect();
        let ck = cp_link::sample_ck(&mut rng, data_len);
        let (link_pk, link_vk) = cp_link::key_gen(ck.clone(), cks, &mut rng);
